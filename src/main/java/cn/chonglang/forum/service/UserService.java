...
import cn.chonglang.forum.dto.ResultDTO;
...
public class UserService {
    ...
    @Value("${site.password.salt}")     //验证码随机生成
    private String salt;
    ...
    public String getUserName(String authorizeSize) {    //初始用户姓名。在abcdefghijklmnopqrstuvwxyz1234567890中随机生成5位
