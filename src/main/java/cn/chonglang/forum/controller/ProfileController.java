...
import cn.chonglang.forum.mapper.UserInfoMapper;
import cn.chonglang.forum.mapper.UserMapper;
import cn.chonglang.forum.model.*;
import cn.chonglang.forum.service.NotificationService;
...
public class ProfileController {
    ...
    public String messeage(HttpServletRequest request,   //用户消息
                          Model model,
    ...
    public String getSetPage(HttpServletRequest request,
        ...
        if("account".equals(action)){
            ...
            model.addAttribute("vaptcha_vid", vaptcha_vid);  //调取验证，查看是检验码是否通过
            return "user/account";
        }
        return "user/set";
    }
