...
import cn.chonglang.forum.annotation.UserLoginToken;
...
import cn.chonglang.forum.service.UserInfoService;
...
public class UserController {
    ...
    public String getUserHome(@PathVariable(name="userId",required = false) String userId,
        ...
        if (user != null) {
            UserAccount userAccount = userAccountService.selectUserAccountByUserId(user.getId());         //调用serivce层方法
